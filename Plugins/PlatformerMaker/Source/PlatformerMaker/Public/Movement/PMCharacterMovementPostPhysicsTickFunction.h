...
#include "PMCharacterMovementPostPhysicsTickFunction.generated.h"
 ...
 **/
USTRUCT()
struct FPMCharacterMovementPostPhysicsTickFunction : public FTickFunction
{
...
template<>
struct TStructOpsTypeTraits<FPMCharacterMovementPostPhysicsTickFunction> : public TStructOpsTypeTraitsBase2<FPMCharacterMovementPostPhysicsTickFunction>
{
	enum
	{
		WithCopy = false
